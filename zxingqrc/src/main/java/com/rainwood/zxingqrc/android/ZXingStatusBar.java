...
public class ZXingStatusBar {
    ...
    public static void setTranslucent(Activity activity, @IntRange(from = 0, to = 255) int statusBarAlpha) {
        ...
        addTranslucentWithRectView(activity, statusBarAlpha);
    }
    ...
    public static void setTranslucent(Activity activity, View needOffsetView) {
        ...
        if (needOffsetView != null) {
            ...
            needOffsetView.getLayoutParams().height += getStatusBarHeight(activity);
     ...
     */
    private static void addTranslucentWithRectView(Activity activity, @IntRange(from = 0, to = 255) int statusBarAlpha) {
        ViewGroup contentView = (ViewGroup) activity.findViewById(android.R.id.content);
