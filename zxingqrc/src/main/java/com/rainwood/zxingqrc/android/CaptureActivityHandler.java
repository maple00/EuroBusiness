...
import com.rainwood.zxingqrc.decode.DecodeThread;
import com.rainwood.zxingqrc.view.ViewfinderResultPointCallback;
 ...
 * aty_zxing_capture. 该类用于处理有关拍摄状态的所有信息
 *
...
public final class CaptureActivityHandler extends Handler {
    ...
    public CaptureActivityHandler(QRCodeCaptureActivity activity,
    ...
    public void handleMessage(Message message) {
        ...
        Log.d("scan code: ", "what: " + message.what  + ", String: " + message.toString());
