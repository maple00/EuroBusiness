package com.rainwood.eurobusiness.other;
...
import com.rainwood.eurobusiness.ui.dialog.WaitDialog;
...
public final class StatusManager {
    ...
    public void showError(View view) {
        ...
        if (isNetworkAvailable(view.getContext())) {
            ...
            showLayout(view, R.drawable.icon_hint_network, R.string.hint_layout_error_network);
        }
    }
