 ...
 * @Desc: 选择参数属性 ----- 颜色或者尺寸
 */
public class StockSpecialAdapter extends BaseAdapter {

    private Context mContext;
    private List<SpecialParamsBean> mList;

    public StockSpecialAdapter(Context mContext, List<SpecialParamsBean> mList) {
    ...
    @Override
    public SpecialParamsBean getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (getItem(position).isHasSelected()) {
